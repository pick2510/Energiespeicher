...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.3]{images/Meltinginsidesphere.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.3]{images/meltingphasefront.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.6]{images/heatconductionin.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.5]{images/threedimensionalphysicalmodel.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.6]{images/simulatedvelocity.png}
\caption{Vergleich zwischen Enthalpie und Temperatur \cite{WasteEnergyHarvesting}}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.6]{images/configurationofthecarbonnanofibers.png}
